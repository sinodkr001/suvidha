  ...
  return (
    <footer className="relative bg-gradient-to-b from-gray-900 via-slate-900 to-black py-20 overflow-hidden">
      ...
      <motion.a 
        ...
        className="fixed bottom-4 left-4 md:bottom-6 md:left-6 bg-gradient-to-r from-orange-500 to-orange-600 text-white p-3 md:p-4 rounded-2xl shadow-2xl transition-all duration-300 hover:shadow-orange-500/50 z-50"
        whileHover={{ 
          scale: 1.1,
