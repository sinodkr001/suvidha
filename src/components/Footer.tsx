  ...
  return (
    <footer className="relative bg-gradient-to-b from-gray-900 via-slate-900 to-black py-20 overflow-hidden">
      ...
      <motion.a 
        ...
        className="fixed bottom-6 left-6 bg-gradient-to-r from-green-500 to-green-600 hover:from-green-600 hover:to-green-700 text-white p-4 rounded-2xl shadow-2xl hover:shadow-green-500/25 transition-all duration-300 z-50"
        whileHover={{ scale: 1.1, rotate: 5 }}
        whileTap={{ scale: 0.95 }}
