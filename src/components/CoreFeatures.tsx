    ...
    <section className="py-20 bg-gradient-to-br from-gray-50 via-white to-orange-50 relative overflow-hidden">
      ...
      <div className="container mx-auto px-6 sm:px-12 lg:px-24 relative z-10">
        ...
        <div className="text-center mt-20">
          <button onClick={() => window.location.assign('/outlet-types')} className="bg-gradient-to-r from-orange-500 via-orange-600 to-pink-600 text-white px-12 py-5 rounded-2xl transition-all duration-300 hover:shadow-[0_10px_30px_rgba(251,146,60,0.3)] hover:scale-105 font-semibold flex items-center gap-3 mx-auto group">
